				...
				<div className="w-full lg:w-1/2 mt-5 p-2 rounded text-lg">
					...
					<div className="text-md my-5">
						...
						<p>
							...
							can create, edit, and delete your own posts. Each time you post,
							the cookie's expiration extends, keeping it active. If you don't
							post/edit a post/delete a post before your cookie expires in one
							(1) week, you'll lose editing/deleting rights to your posts, even
							though you authored them. To maintain access to your posts, keep
							your session active by posting/editing/deleting within the week.
							Additionally, avoid including any personal or identifiable
							information in your posts. To prevent spamming, you are limited to
							10 posts per hour. The same goes for editing existing posts.
							<br />
							<br />
